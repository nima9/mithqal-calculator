...
>
	...
	<span
		aria-hidden="true"
		class="invisible whitespace-pre py-1 pl-6 pr-1 font-karla font-medium {variant === 'header'
			? 'text-xl'
			: 'text-lg'}"
	>
	...
	<select
		...
		class="absolute inset-0 z-10 h-full w-full min-w-0 cursor-pointer appearance-none bg-transparent py-1 pl-6 pr-1 font-karla font-medium text-base-content outline-hidden focus-visible:ring-2 focus-visible:ring-primary {variant ===
		'header'
			? 'text-xl'
			: 'text-lg'}"
		aria-label="Language"
